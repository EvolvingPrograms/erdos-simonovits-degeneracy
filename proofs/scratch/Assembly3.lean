...
Machinery for Theorem 1.2 at `r = 3`; the target statements built on top of it are in
`Theorem12r3.lean`.  This route is independent of the general `r` pipeline —
this file does not import `proofs/lib/AssemblyR.lean` — and certifies the weaker
...
-- **Theorem 1.2 at `r = 3` with the explicit exponent** `5/3 + 1/4000`.
open Classical in
