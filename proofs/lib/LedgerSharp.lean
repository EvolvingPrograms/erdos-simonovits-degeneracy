...
limits Theorem 1.2's explicit constant to `1/(110 r²)` at the midpoint with
...
per-`r` interval value of `width(2)` (Lemma 4.4's uniform `0.00603` is what
...
/-- **The sharp `r = 3` gain**: `ε₃ ≥ 1/160`, given Lemma 4.4's
window bound at `r = 3` (`width ≥ 0.0098/9`, discharged in `proofs/lib/AssemblyR.lean`).
