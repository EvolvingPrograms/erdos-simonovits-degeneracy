/-
  Provenance
  ==========
  This file is a verbatim, unmodified copy of

      proofs/CompactnessAndDegeneracy.lean

  from OpenAI's `ten-proofs` repository <https://github.com/openai/ten-proofs>,
  the Lean development accompanying "Ten advances in mathematics and
  theoretical computer science" (2026); see chapter 10, "Counterexamples to
  the Compactness and Degeneracy Conjectures for Extremal Numbers".
  Copyright OpenAI, licensed under the Apache License, Version 2.0
  <https://www.apache.org/licenses/LICENSE-2.0>.

  Nothing below this comment has been altered.  It is vendored here as the
  upstream prerequisite of the present development, which generalizes the
  `r = 2` degeneracy counterexample of that chapter to every `r`.  Where
  comments elsewhere in `lib/` speak of "the published file" or "the
  published `r = 2` development", they mean this file.
-/
