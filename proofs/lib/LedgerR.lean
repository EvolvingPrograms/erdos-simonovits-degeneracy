...
that the window is open.  That is Lemma 4.4's job, and this file deliberately does
...
of Theorem 1.2 is applied **once**, giving `ε_r ≥ w/(4K₁r²)`.
-/
...
/-- Theorem 1.2's instance: `η_r = 1/2`, so `ε_r ≥ w/(4K₁r²)`.  The halving is
...
/-- **Theorem 1.2's exponent, explicit.**  At `λ = 27/20`, given
